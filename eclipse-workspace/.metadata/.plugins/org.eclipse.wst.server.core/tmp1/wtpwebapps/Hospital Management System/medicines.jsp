...
<form action="MedicineServlet" method="POST" name="billForm">
   <%
      ...
      //  System.out.println("medname>>>>>>>>>>>>>>>>>>>>>"+medicinename);
        ...
        %>
        <h2 style="padding-left: 474px;">Pharmacy</h2>
...
<p>
   <h2 style="padding-left: 474px;">Medicines Issued</h2>
<table style="width:80%" align="center" border="2" >
<tr bgcolor="black">
<th>
...
<div style="padding-left: 592px;"><input type="submit" value="Issue Medicines" name="Issue Medicines"></div>
