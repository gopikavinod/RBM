...
alter table tbl_issued_medicine add total_amount number;
select * from tbl_issued_medicine;
insert into tbl_issued_medicine (patient_id,medicine_name,quantity,medicine_id)values('12','Albentazol1','2','1003','2','4');
...
insert into tbl_issued_medicine (patient_id,medicine_name,quantity,medicine_id)values('11','Albentazol1','2','1003','2','4');
update tbl_issued_medicine set rate='2.00',total_amount ='4.00' where medicine_id='1000'
...
select rate ,b.medicine_id from tbl_medicine a inner join (select medicine_id,medicine_name,quantity from tbl_issued_medicine) b on a.medicine_id=b.medicine_id;

select * from tbl_medicine  a inner join  (select * from tbl_issued_medicine  where patient_id='12') b on a.medicine_id=b.medicine_id inner join  (select patient_id from tbl_patient where patient_id='12')c on b.patient_id=c.patient_id ;
