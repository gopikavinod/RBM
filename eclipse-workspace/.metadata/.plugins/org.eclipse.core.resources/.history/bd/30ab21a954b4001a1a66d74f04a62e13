...
<form  action="UpdateCustomerServlete" name="updateCustomer"  method="post"   style="margin-top: 95px;
    margin-left: 299px;">
...
<tr>
<td>New Customer Name<span class="aestric">*</span>:</td>
<td><input type="text" id="ncname" name="newcustname" value="" required="required" ></td>
</tr>
<tr>
<td>Old Address:</td>
...
<tr>
<td>New Address<span class="aestric">*</span>:</td>
<td> <input type="text" id="naddress" name="customernaddress" value="" required="required" ></td>
</tr>
<tr>
<td>Old Age:</td>
...
<tr>
<td>New Age<span class="aestric">*</span>:</td>
<td> <input type="text" id="nage" name="customernage" value="" required="required"></td>
</tr>
<tr>
